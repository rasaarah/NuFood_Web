  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-3 text-center fh5co-heading animate-box">
        ...
        <!--search-->
        <form class="form-inline" action="<?php print site_url();?>/karyawan/c_karyawan/add_alternatif_satu_malam" method=POST>
    ...
    <div class="row">
      <?php foreach ($makanan as $row) { 
        ...
        <div class="col-md-3 animate-box" style="min-height:60%;">
          <div class="price-box">
            <form action="<?= site_url('karyawan/c_karyawan/add_alternatif_satu_malam_aksi');?>" method="post">
